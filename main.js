...
class Klava {
  constructor() {
    ...
    const secondRow = [
      ...
      { code: '56', first: 'i', second: 'ш', type: 'letter' },
      { code: '73', first: 'o', second: 'щ', type: 'letter' },
      { code: '79', first: 'p', second: 'з', type: 'letter' },
      { code: '80', first: '[', second: 'х', type: 'letter' },
